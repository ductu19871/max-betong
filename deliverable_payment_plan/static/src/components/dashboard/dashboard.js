...
OutputDashboard.template = "deliverable_payment_plan_dashboard.Dashboard";
OutputDashboard.components = { Many2XAutocomplete };

registry.category("actions").add("deliverable_payment_plan_dashboard_action", OutputDashboard);
